...
In this project, I will use data cleaning, analysis, and visualisations in order to generate insights for a business stakeholder.

## Business Problem

My company is expanding into new industries to diversify its portfolio. Specifically, they are interested in buying and operating aircraft for commercial and private use, but do not know anything about the potential risks of aircraft. My task is to analyse the data and come up with three business recommendations.

## The Data

The data used in this project is from the NTSB (National Transportation Safety Board), that contains information from 1962 and later about civil aviation accidents and selected incidents within the United States, its territories and possessions, and international waters. Some of the important variables in the dataset are: Aircraft damage, category, make, model, number of engines, engine type, injury severity and total injuries.
...
Visual number 1 is "Total Fatal Injuries by Make" , this first chart tells us which aircraft makes have been involved in the highest number of fatal incidents, but this does not necessarily mean they are the most dangerous (Boeing and Cessna for example) , this reflects that these manufacturers have a much larger number of aircraft in operation, meaning they are the most popular makes in those years.
...
Visual number 3 is "Fatal Injury Rate and Total Fatal Injuries by Engine Type", this will give us a good insight about which engine types are safest.

### Visual 4
![example](images/Visualization_4.png)

Visual number 4 is  "Fatality Rate by Aircraft Model", this visualization is useful to understand which aircraft model are the safest using fatality rate as a measurement.
